...
function MembershipPage() {
    ...
    <div className="membership-page">
        <div className="header">
            ...
            <section>
                <h1>Membership</h1>
                <p className={"caption-text"}>SHIMA Membership is annual. If you are unsure if you are currently a member,
        ...
        <div className="apply-section">
            ...
            <h4>Online</h4>
            <p>
                Apply for membership on the 2024 SHIMA membership form by logging into your SHIMA account and completing the application form, including payment.
