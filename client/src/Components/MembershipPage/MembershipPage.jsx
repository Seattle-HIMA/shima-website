                ...
                <div>
                    <div class="membership-title">
                        ...
                        <div class="centered">
                            <h1 class="membership-h1">Membership</h1>
                            <p className={"caption-text"}>
                                SHIMA Membership is annual. If you are unsure if you are currently a member, please feel
                                free to
                                email us.
                            </p>
                            <button class="apply-button">Apply now</button>
                    ...
                    <div class="information-section">
                        <div>
                            ...
                            <p class="caption">Here at SHIMA, we offer discounted workshops, professional development,
                                networking opportunities, Inexpensive Continuing Education Units (CEUs), and
                                volunteering to
                                members.</p>
                            <div id="annual-rates">
                        ...
                        <div class="apply-section">
                            <div class="apply-text">
                                ...
                                <h4>Online</h4>
                                <p class="caption">
                                    Complete the 2024 SHIMA membership form below <span class="bold">OR</span> by
                                    scanning the
                                    QR code.
